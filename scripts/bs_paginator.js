  ...
  if (prevNext){
    if (current > 1) {
      result += '<li><a class="page-prev" rel="prev" ' +
              'href="' + link(current - 1) + '"><i class="fa fa-chevron-left"></i>' + prevText + '</a></li>';
    } else {
      result += '<li class="disabled"><span class="page-prev"><i class="fa fa-chevron-left"></i>'  + prevText + '</a></li>';
    }
  }
  ...
  if (prevNext){
    if (current < total) {
      result += '<li><a class="page-next" rel="next" ' +
              'href="' + link(current + 1) + '">' + nextText + ' <i class="fa fa-chevron-right"></i></a></li>';
    } else {
      result += '<li class="disabled"><span class="page-next">' + nextText + ' <i class="fa fa-chevron-right"></i></a></li>';
    }
  }
